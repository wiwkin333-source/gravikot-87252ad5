  ...
  if (variant === "primary") {
    return (
      <a href={href} className={`${base} text-black`}>
        ...
        />
        <Bolt className="spark h-3 w-3" style={{ top: -8, left: -6, ["--r" as any]: "-20deg", animationDelay: "0s" }} />
        <Bolt className="spark h-2.5 w-2.5" style={{ top: -10, right: 14, ["--r" as any]: "18deg", animationDelay: "0.4s" }} />
        <Bolt className="spark h-3 w-3" style={{ bottom: -8, right: -6, ["--r" as any]: "160deg", animationDelay: "0.9s" }} />
        <Bolt className="spark h-2.5 w-2.5" style={{ bottom: -10, left: 18, ["--r" as any]: "200deg", animationDelay: "1.4s" }} />
        <Bolt className="spark h-2 w-2" style={{ top: 6, right: -10, ["--r" as any]: "60deg", animationDelay: "1.8s" }} />
          ...
          <div className="relative">
            ...
            <div className="relative animate-float">
              ...
              <div className="absolute -left-4 top-10 flex flex-col gap-2">
                <div className="glass rounded-xl px-3 py-2 text-xs font-tech uppercase tracking-[0.18em] animate-float" style={{ animationDelay: "1.5s", color: "#1e3a8a" }}>
                  <span style={{ color: "#1e3a8a" }}>●</span> LASER CRAFT
                </div>
                <div className="glass rounded-xl px-3 py-2 text-xs font-tech uppercase tracking-[0.18em] animate-float" style={{ animationDelay: "2.2s", color: "#1e3a8a" }}>
                  <span style={{ color: "#1e3a8a" }}>●</span>&nbsp;&nbsp;&nbsp;0,06 MM
                </div>
              </div>
            </div>
          </div>
